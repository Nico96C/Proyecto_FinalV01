        ...
        <div className="agenda">
            ...
            <div className="agenda-content">
                ...
                <ul className="agenda-list">
                    <li>Evento 1: Taller de cocina - Fecha: 15 de octubre</li>
                    <li>Evento 2: Charla sobre tecnología - Fecha: 20 de octubre</li>
                    <li>Evento 3: Fiesta de cierre - Fecha: 30 de octubre</li>
                </ul>
            </div>
        </div>
    )
